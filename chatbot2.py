...
class Chatbot2:
    ...
    def generate_summary(self):
        ...
        message = response.choices[0].message
        self.summary = message.content

        return self.summary  # 요약 문자열 반환



class TTSChatbot2(Chatbot2):
    def text_to_speech(self, text):
        ...
        # Flask 애플리케이션 컨텍스트에서 url_for 호출
        audioUrl = url_for('static', filename=f"audio/{file_name}", _external=True)
    ...
    def get_response(self, user_input):
        ...
        audioUrl = self.text_to_speech(ai_response)
        self.exchange_count += 1

        return self.get_response_content(), audioUrl
